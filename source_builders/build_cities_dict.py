...
wb = load_workbook(filename ='miasta.xlsx')
sheet_ranges = wb['Miasta']

# - - - - - - - - - - - - - - - - - - - - - - - - - - - -
ref_path_to_main_root = "../"
FROM_ROOT = ref_path_to_main_root

umbrella_file_name = "miasta_baza"
umbrella_file_dir = FROM_ROOT + "built_source/"
umbrella_import_tree = "built_source.miasta."  # full import -> umbrella_import_tree + filename

data_file_dir = FROM_ROOT + "built_source/miasta/"
data_file_start_name = "miasta_baza_"
data_file_import_tree = "built_source."  # full import -> data_file_import_tree + filename

ENCODE = "UTF-8"
main_dict_name = "dict_cities"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - -
